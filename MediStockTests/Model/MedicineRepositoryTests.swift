...
struct MedicineRepositoryTests {
    ...
    @Test func updateMedicineNoThrowError() async throws {
        ...
        await #expect(throws: Never.self) {
            ...
            XCTAssertNotNil(updatedMedicines)
        }
    }
    ...
    @Test func updateStockNotThrowError() async throws {
        ...
        XCTAssert(mockMedicineService.historyEntry.first?.action == "Update")
        XCTAssert(mockMedicineService.historyEntry.first?.stock == 50)
        XCTAssert(mockMedicineService.testMedicines.first?.stock == 10)
    ...
    @Test func updateStoctThrowError() async throws {
        ...
        //Then
        XCTAssert(mockMedicineService.historyEntry.isEmpty)
